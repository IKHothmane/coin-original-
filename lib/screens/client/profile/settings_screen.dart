...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  bool _usesEmailPassword(AuthProvider authProvider) {
  ...
  Future<void> _deleteAccount() async {
    ...
    final needsPassword = _usesEmailPassword(authProvider);
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            const Text(
              'Cette action est definitive. Votre compte et vos donnees '
              'associees (profil, favoris) seront supprimes.',
            ),
            if (needsPassword) ...[
              ...
              const Text(
                'Une confirmation via Google ou Apple peut etre demandee.',
              ),
            ],
          ],
        ),
    ...
    if (success) {
      ...
      _showSnackBar('Votre compte a ete supprime.');
      return;
    }

    final error = authProvider.error ?? 'Suppression impossible';
    if (error.contains('REAUTH_PASSWORD_REQUIRED')) {
      _showSnackBar('Mot de passe requis pour supprimer le compte.');
      return;
    }
    _showSnackBar(error);
  }
      ...
      builder: (context) => AlertDialog(
        ...
        content: const SingleChildScrollView(
          child: Text(
            ...
            'Vous pouvez supprimer votre compte a tout moment depuis Parametres > Supprimer mon compte.',
          ),
        ),
        actions: [
          TextButton(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildTile(
            ...
            subtitle: 'Suppression definitive du compte',
