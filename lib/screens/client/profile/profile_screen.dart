...
import 'package:coin_original_mobile/utils/contact_utils.dart';
  ...
  Widget _buildMenuList(BuildContext context, AuthProvider authProvider) {
    final items = [
      ...
      MenuItem(
        ...
        () => ContactUtils.openInstagram(context),
      ),
      MenuItem(
        Icons.chat_bubble_outline,
        'WhatsApp · ${AppContact.whatsAppPhone}',
        const Color(0xFFE8F5E9),
        () => ContactUtils.openWhatsApp(
          context,
          message: 'Bonjour Coin Original, ',
        ),
      ),
